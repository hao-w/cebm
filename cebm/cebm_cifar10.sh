...
# python3 cebm_gmm_sgld.py  --seed=1 --device=0 --dataset=cifar10 --data_dir=../../sebm_data/ --batch_size=100  \
# --num_epochs=100 --buffer_init --buffer_dup_allowed  \ 
# --hidden_dim=[128]

# python3 cebm_gmm_sgld.py  --seed=1 --device=0 --dataset=svhn --data_dir=../../sebm_data/ --batch_size=100  \
