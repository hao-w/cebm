...
if __name__ == "__main__":
    ...
    from sebm.models import Generator, Discriminator_BIGAN, Encoder_BIGAN
...
#     parser.add_argument('--reparameterized', default=True, )
    ...
    save_version = 'bigan-d=%s-seed=%d-lr=%s-zd=%d-disc_act=%s-gen_act=%s-arch=%s' % (args.dataset, args.seed, args.lr, args.latent_dim, args.disc_activation, args.gen_activation, args.arch)
