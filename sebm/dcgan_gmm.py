...
#     parser.add_argument('--mlp_output_dim', default=288, type=int)
    ...
    save_version = 'dcgan_gmm-d=%s-seed=%d-lr=%s-zd=%d-disc_act=%s-gen_act=%s-arch=%s' % (args.dataset, args.seed, args.lr, args.latent_dim, args.disc_activation, args.gen_activation, args.arch)
