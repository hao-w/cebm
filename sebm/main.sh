...
# vae-mnist-heldout
python3 vae.py --seed=1 --device=0 --dataset=mnist --data_dir=../../sebm_data/ --batch_size=100 --reparameterized --optimizer=Adam --lr=1e-4  --latent_dim=128 --num_epochs=150 --arch=simplenet2 --activation=ReLU --heldout_class=0

python3 vae.py --seed=1 --device=0 --dataset=mnist --data_dir=../../sebm_data/ --batch_size=100 --reparameterized --optimizer=Adam --lr=1e-4  --latent_dim=128 --num_epochs=150 --arch=simplenet2 --activation=ReLU --heldout_class=4

python3 vae.py --seed=1 --device=0 --dataset=mnist --data_dir=../../sebm_data/ --batch_size=100 --reparameterized --optimizer=Adam --lr=1e-4  --latent_dim=128 --num_epochs=150 --arch=simplenet2 --activation=ReLU --heldout_class=9

python3 vae.py --seed=1 --device=0 --dataset=mnist --data_dir=../../sebm_data/ --batch_size=100 --reparameterized --optimizer=Adam --lr=1e-4  --latent_dim=128 --num_epochs=150 --arch=simplenet2 --activation=ReLU --heldout_class=5
