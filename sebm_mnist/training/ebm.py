...
def train(optimizer, ef, sgld_sampler, data_noise_sampler, train_data, num_epochs, sample_size, sgld_num_steps, sgld_step_size, buffer_size, buffer_percent, regularize_alpha, CUDA, DEVICE, SAVE_VERSION):
    """
