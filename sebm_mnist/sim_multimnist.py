...
class Sim_MULTIMNIST():
    """
    ==========
    simulate multi-digit MNIST datasets using the training dataset in MNIST
    ==========
    """
    def __init__(self, num_digits, frame_size, chunk_size):
        super(Sim_MULTIMNIST, self).__init__()
    ...
    def sim_save_data(self, num_canvases, MNIST_DIR, PATH):
        ...
        print('Start to simulate multi-mnist images...')
        counter = 1
