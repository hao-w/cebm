...
class wide_basic(nn.Module):
    def __init__(self, in_planes, planes, dropout_rate, stride=1, leak=.2):
...
class Wide_ResNet(nn.Module):
    """
    The Wide Residual Networks-28-10 used in the Joint Energyed Based Model
    source code: https://github.com/wgrathwohl/JEM/blob/master/wideresnet.py
    Note that any batch normalization operation was removed since other papers 
    found that type of operations is harmful to training.
    """
    def __init__(self, depth, widen_factor, num_classes=10, input_channels=3,
                 sum_pool=False, leak=.2, dropout_rate=0.0):
